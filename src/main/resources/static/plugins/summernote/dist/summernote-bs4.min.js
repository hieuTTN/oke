...
!function (t, e) {
    ...
    var e = function () {
        ...
        r = o('<div class="note-editing-area"/>'), s = o('<textarea class="note-codable"/>'),
        ...
        c = o('<div class="note-editor"/>'), d = o('<div class="note-editable" contentEditable="true"/>'),
        u = o('<div class="note-btn-group btn-group">'), h = o('<div class="dropdown-menu">', function (e, o) {
        ...
        }), m = o('<div class="modal" aria-hidden="false" tabindex="-1"/>', function (t, e) {
            e.fade && t.addClass("fade"), t.html(['<div class="modal-dialog">', '  <div class="modal-content">', e.title ? '    <div class="modal-header">      <h4 class="modal-title">' + e.title + '</h4>      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>    </div>' : "", '    <div class="modal-body">' + e.body + "</div>", e.footer ? '    <div class="modal-footer">' + e.footer + "</div>" : "", "  </div>", "</div>"].join(""))
        }),
        g = o(['<div class="note-popover popover in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""), function (t, e) {
            ...
            e.id && t.attr("for", e.id), t.html([' <input type="checkbox" class="custom-control-input"' + (e.id ? ' id="' + e.id + '"' : ""), (e.checked ? " checked" : "") + "/>", ' <span class="custom-control-indicator"></span>', ' <span class="custom-control-description">' + (e.text ? e.text : "") + "</span>", "</label>"].join(""))
        }), b = function (t, e) {
            ...
            options: {},
            button: function (t, e) {
                return o('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1">', function (t, e) {
    ...
    var N = {
        head: w, last: x, initial: function (t) {
            ...
            for (var e = [], o = 0, n = t.length; o < n; o++) T(e, t[o]) || e.push(t[o]);
            return e
        }
    }, E = "function" == typeof define && define.amd;
    var A, R = navigator.userAgent, L = /MSIE|Trident/i.test(R);
    if (L) {
    ...
    var F = "ontouchstart" in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
        z = L || H ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input", B = {
    ...
    var Nt = {
        ...
        replace: function (t, e) {
            ...
            var o = St(e);
            return t.style.cssText && (o.style.cssText = t.style.cssText), ut(o, N.from(t.childNodes)), dt(o, t), It(t), o
        },
        html: function (e, o) {
            var n = $t(e);
    ...
    var Pt = function () {
        ...
        return e.prototype.nativeRange = function () {
            ...
            var e = Lt({node: this.sc, offset: this.so});
            return e.setEndPoint("EndToEnd", Lt({node: this.ec, offset: this.eo})), e
            ...
            var t = this.nativeRange();
            return B.isW3CRangeSupport ? t.toString() : t.text
        ...
        create: function (t, e, o, n) {
            if (4 === arguments.length) return new Pt(t, e, o, n);
            if (2 === arguments.length) return new Pt(t, e, o = t, n = e);
    ...
    var Ot, Ut = function () {
        ...
        function e(e) {
            ...
            for (var n = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor"], i = 0, r = n.length; i < r; i++) this[n[i]] = (s = n[i], function (t) {
                o.beforeCommand(), document.execCommand(s, !1, t), o.afterCommand(!0)
            ...
            for (i = 1; i <= 6; i++) this["formatH" + i] = (a = i, function () {
                o.formatBlock("H" + a)
            ...
            this.insertParagraph = this.wrapCommand(function () {
                ...
                if (!o.isLimited(t(e).text().length)) {
                    o.createRange().insertNode(e), Ht.createFromNodeAfter(e).select()
                }
        ...
        return e.prototype.initialize = function () {
            ...
            }), this.$editable.html(Nt.html(this.$note) || Nt.emptyPara), this.$editable.on(B.inputEventName, C.debounce(function () {
            ...
            var e = this.options.keyMap[B.isMac ? "mac" : "pc"], o = [];
            ...
            return (i = e, t.Deferred(function (e) {
                ...
                }).css({display: "none"}).appendTo(document.body).attr("src", i)
            }).promise()).then(function (t) {
                n.beforeCommand(), "function" == typeof o ? o(t) : ("string" == typeof o && t.attr("data-filename", o), t.css("width", Math.min(n.$editable.width(), t.width()))), t.show(), Ht.create(n.editable).insertNode(t[0]), Ht.createFromNodeAfter(t[0]).select(), n.afterCommand()
            }).fail(function (t) {
    ...
    B.hasCodeMirror && (B.isSupportAmd ? require(["codemirror"], function (t) {
        Ot = t
    ...
    var Vt = function () {
        ...
        return t.prototype.sync = function () {
            this.isActivated() && B.hasCodeMirror && this.$codable.data("cmEditor").save()
        ...
        function e(e) {
            this.ui = t.summernote.ui, this.context = e, this.$toolbar = e.layoutInfo.toolbar, this.options = e.options, this.lang = this.options.langInfo, this.invertedKeyMap = C.invertObject(this.options.keyMap[B.isMac ? "mac" : "pc"])
        }

        return e.prototype.representShortcut = function (t) {
            var e = this.invertedKeyMap[t];
            return this.options.shortcuts && e ? (B.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
            ...
            return this.fontInstalledMap.hasOwnProperty(t) || (this.fontInstalledMap[t] = B.isFontInstalled(t) || N.contains(this.options.fontNamesIgnoreCheck, t)), this.fontInstalledMap[t]
            ...
            return t.Deferred(function (t) {
                ...
                o.ui.onDialogShown(o.$dialog, function () {
                    ...
                    i.on("input", l).on("paste", function () {
                        setTimeout(l, 0)
                    }).val(e.url), B.isSupportTouch || i.trigger("focus"), o.toggleLinkBtn(r, n, i), o.bindEnterKey(i, r), o.bindEnterKey(n, r);
        ...
        return e.prototype.initialize = function () {
            ...
            return t.Deferred(function (t) {
                ...
                o.ui.onDialogShown(o.$dialog, function () {
                    ...
                    }), B.isSupportTouch || n.trigger("focus"), i.click(function (e) {
                        e.preventDefault(), t.resolve(n.val())
                    }), o.bindEnterKey(n, i)
                }), o.ui.onDialogHidden(o.$dialog, function () {
        ...
        return e.prototype.initialize = function () {
            ...
            var e = this, o = this.options.keyMap[B.isMac ? "mac" : "pc"];
        ...
        function e(e) {
            ...
            this.context = e, this.ui = t.summernote.ui, this.options = e.options, this.events = {
                "summernote.keyup summernote.mouseup summernote.scroll": function () {
                    ...
                    B.isFF || e.relatedTarget && Nt.ancestor(e.relatedTarget, C.eq(o.$popover[0])) || o.hide()
                }
            }
        }
    ...
    t.fn.extend({
        ...
        version: "0.8.9", ui: y, dom: Nt, plugins: {}, options: {
            modules: {
                editor: jt,
                clipboard: qt,
                dropzone: Kt,
