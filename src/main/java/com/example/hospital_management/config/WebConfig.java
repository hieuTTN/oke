...
//                .setCacheControl(CacheControl.maxAge(2, TimeUnit.HOURS).cachePublic());
        ...
        registry.addResourceHandler("/jsadmin/**").addResourceLocations("classpath:/static/jsadmin/")
                .setCacheControl(CacheControl.maxAge(2, TimeUnit.HOURS).cachePublic());
        registry.addResourceHandler("/jsemployee/**").addResourceLocations("classpath:/static/jsemployee/")
                .setCacheControl(CacheControl.maxAge(2, TimeUnit.HOURS).cachePublic());
        registry.addResourceHandler("/jsdoctor/**").addResourceLocations("classpath:/static/jsdoctor/")
                .setCacheControl(CacheControl.maxAge(2, TimeUnit.HOURS).cachePublic());
        registry.addResourceHandler("/boostrap/**").addResourceLocations("classpath:/static/boostrap/")
                .setCacheControl(CacheControl.maxAge(2, TimeUnit.HOURS).cachePublic());
